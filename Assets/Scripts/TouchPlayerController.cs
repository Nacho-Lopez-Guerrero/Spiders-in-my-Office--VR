...
public class TouchPlayerController : MonoBehaviour{
	static private TouchPlayerController[] joysticks;                    // A static collection of all joysticks
	...
	{ 
			...
			
		{
			...
			joysticks = (TouchPlayerController[])  FindObjectsOfType( typeof(TouchPlayerController) );
			...
			
		{
				...
				
			{
					...
					
				{
					...
					foreach ( TouchPlayerController j in joysticks )
